---
name: open
description: Orient to the current project — reads CLAUDE.md map, git state, .protocol.md focus, and DESIGN.md head. Run at session start or to reorient mid-session.
---
...
- If absent: stop and suggest running `/setup` to scaffold the project.
